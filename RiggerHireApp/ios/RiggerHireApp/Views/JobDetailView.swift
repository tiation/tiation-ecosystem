...
struct JobDetailView: View {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showApplicationForm) {
            // TODO: Implement JobApplicationView
            EmptyView()
        }
    }
...
struct JobDetailView_Previews: PreviewProvider {
    static var previews: some View {
        JobDetailView(job: Job(
            title: "Senior Rigger",
            description: "Looking for an experienced rigger for a major construction project",
            location: Location(address: "123 Perth St", city: "Perth", state: "WA", postcode: "6000", country: "Australia", siteType: .construction),
            rate: 75.0,
            jobType: .rigger,
            duration: .weekly,
            startDate: Date(),
