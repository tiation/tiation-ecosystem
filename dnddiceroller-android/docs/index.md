---
layout: default
title: Dnddiceroller Android - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Dnddiceroller Android</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/dnddiceroller-android" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t dnddiceroller-android .

# Run container
docker run -p 8080:8080 dnddiceroller-android
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/dnddiceroller-android)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/dnddiceroller-android/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/dnddiceroller-android/discussions)
