---
layout: default
title: Architecture Diagrams - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Architecture Diagrams</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/architecture-diagrams" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
# Run container
docker run -p 8080:8080 architecture-diagrams
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/architecture-diagrams)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/architecture-diagrams/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/architecture-diagrams/discussions)
