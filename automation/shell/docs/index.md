---
layout: default
title: Scripts - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Scripts</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/scripts" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
# Run container
docker run -p 8080:8080 scripts
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/scripts)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/scripts/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/scripts/discussions)
