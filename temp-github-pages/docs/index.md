---
layout: default
title: Temp Github Pages - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Temp Github Pages</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/temp-github-pages" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t temp-github-pages .

# Run container
docker run -p 8080:8080 temp-github-pages
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/temp-github-pages)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/temp-github-pages/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/temp-github-pages/discussions)
