---
layout: default
title: Tiation Automation Workspace - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Tiation Automation Workspace</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/tiation-automation-workspace" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t tiation-automation-workspace .

# Run container
docker run -p 8080:8080 tiation-automation-workspace
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/tiation-automation-workspace)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/tiation-automation-workspace/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/tiation-automation-workspace/discussions)
