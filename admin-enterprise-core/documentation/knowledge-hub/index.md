---
layout: default
title: Tiation Knowledge Hub - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Tiation Knowledge Hub</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/tiation-knowledge-hub" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
![Architecture Diagram](../assets/architecture/tiation-knowledge-hub-architecture.svg)
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/tiation/tiation-knowledge-hub.git
...
# Run container
docker run -p 8080:8080 tiation-knowledge-hub
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/tiation-knowledge-hub)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/tiation-knowledge-hub/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/tiation-knowledge-hub/discussions)
