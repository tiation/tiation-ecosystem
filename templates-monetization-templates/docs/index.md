---
layout: default
title: Monetization Templates - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Monetization Templates</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/monetization-templates" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t monetization-templates .

# Run container
docker run -p 8080:8080 monetization-templates
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/monetization-templates)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/monetization-templates/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/monetization-templates/discussions)
