---
layout: default
title: Branding_Templates - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Branding_Templates</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/BRANDING_TEMPLATES" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
![Architecture Diagram](../assets/architecture/BRANDING_TEMPLATES-architecture.svg)
...
```bash
# Build Docker image
docker build -t BRANDING_TEMPLATES .

# Run container
docker run -p 8080:8080 BRANDING_TEMPLATES
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/BRANDING_TEMPLATES)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/BRANDING_TEMPLATES/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/BRANDING_TEMPLATES/discussions)
