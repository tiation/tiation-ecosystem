---
layout: default
title: Metricsdashboard - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Metricsdashboard</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/MetricsDashboard" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t MetricsDashboard .

# Run container
docker run -p 8080:8080 MetricsDashboard
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/MetricsDashboard)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/MetricsDashboard/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/MetricsDashboard/discussions)
