---
layout: default
title: Config - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Config</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/config" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/config)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/config/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/config/discussions)
