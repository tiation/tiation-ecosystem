---
layout: default
title: Automationserver - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Automationserver</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/AutomationServer" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t AutomationServer .

# Run container
docker run -p 8080:8080 AutomationServer
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/AutomationServer)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/AutomationServer/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/AutomationServer/discussions)
